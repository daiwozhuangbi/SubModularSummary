...
public class LDADataset {
	...
	/**
	 * set the document at the index idx if idx is greater than 0 and less than M 
	 * @param str string contains doc 一行（个）语料
	 * @param idx index in the document array  第idx行（个）
	 */
	 ...
	 *  读取训练数据，创建新dictionary
	 *  @param filename 训练数据
	 *  @return 成功返回dataset ，失败返回空
	 */
