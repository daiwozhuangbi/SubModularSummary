...
public class Model {	
	 ...
	 * 保存 .tassign文件 - 每列是单词的主题指定（归属），每一行是一个语料文档
	 ...
	 * 保存.theta文件 - 主题文档分布，每一行是一个文档，列内容是主题概率
	 * @param filename 文件保存地址
	 * @return true or false
	 */
	...
	/**
	 * 保存.Phi文件 - 存储词语-主题分布，每一行是一个主题，列内容为词语概率
	 * @param filename 文件保存地址
	 * @return true or false
	 */
